...
public sealed class ClassicCitySetupSessionLookupTests
{
    ...
    {
        Guid ownerUserId = Guid.Parse("9e5ee042-f6cc-4f72-a8d5-a958481511fd");
        Guid sessionId = Guid.Parse("bb3ca890-1793-406b-adf6-b722d43fa77b");
    ...
    {
        Guid ownerUserId = Guid.Parse("0ee376d2-84e2-4888-b45e-1129b46a80d3");
        Guid sessionId = Guid.Parse("b1ac0ef5-fe5e-412a-bda7-c376801ffbb8");
        var sessionStore = new FakeClassicCitySetupSessionStore();
        var publishEndpoint = new RecordingPublishEndpoint();
        sessionStore.Sessions[sessionId] = CreateClassicCitySetupSessionState(
            sessionId: sessionId,
    ...
    {
        Guid ownerUserId = Guid.Parse("8b2cc6fb-24ce-4208-ba6d-230c76346440");
        Guid sessionId = Guid.Parse("80ee12e5-a28c-4a87-9958-b2b2f90efc46");
        var sessionStore = new FakeClassicCitySetupSessionStore();
        var publishEndpoint = new RecordingPublishEndpoint();
