...
internal sealed class TestValidationExceptionFactory : IValidationExceptionFactory
{
    ...
    public MatrixApplicationException Create(Type requestType, IReadOnlyDictionary<string, string[]> errors)
    {
...
internal sealed class TestPermissionChecker : IPermissionChecker
{
    ...
    public Task<bool> HasAsync(Guid userId, string permission, CancellationToken cancellationToken)
    {
        LastUserId = userId;
    ...
    public Task<bool> HasAnyAsync(Guid userId, IReadOnlyCollection<string> permissions, CancellationToken cancellationToken)
    {
        LastUserId = userId;
    ...
    public Task<bool> HasAllAsync(Guid userId, IReadOnlyCollection<string> permissions, CancellationToken cancellationToken)
    {
        LastUserId = userId;
        LastPermissions = permissions.ToArray();
