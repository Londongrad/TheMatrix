...
namespace Matrix.Resources.Api.Tests.Configurations
{
    public sealed class ServicesConfigurationTests
    {
        [Fact]
        public void
            ConfigureApplicationServices_WhenResourcesDbConnectionStringIsMissing_ThrowsInvalidOperationException()
        {
            ...
            Assert.Contains(
                expectedSubstring: "Connection string 'ResourcesDb' is not configured",
