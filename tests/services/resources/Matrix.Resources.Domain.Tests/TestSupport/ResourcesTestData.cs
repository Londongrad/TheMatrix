...
{
    internal static readonly DateTimeOffset CreatedAtUtc = new(2048, 6, 1, 8, 0, 0, TimeSpan.Zero);
        ...
        decimal supplyStressIndex = 0.33m)
    {
        return new CityStockpileSnapshot(
            Fuel: CreateLine(CityResourceKind.Fuel, stockLevelIndex: 0.64m, demandPressureIndex: 0.52m, resupplyReadinessIndex: 0.55m, shortageRiskIndex: 0.40m),
            Food: CreateLine(CityResourceKind.Food, stockLevelIndex: 0.78m, demandPressureIndex: 0.34m, resupplyReadinessIndex: 0.67m, shortageRiskIndex: 0.24m),
            Medicine: CreateLine(CityResourceKind.Medicine, stockLevelIndex: 0.58m, demandPressureIndex: 0.48m, resupplyReadinessIndex: 0.50m, shortageRiskIndex: 0.45m),
            SpareParts: CreateLine(CityResourceKind.SpareParts, stockLevelIndex: 0.61m, demandPressureIndex: 0.46m, resupplyReadinessIndex: 0.49m, shortageRiskIndex: 0.42m),
            Filters: CreateLine(CityResourceKind.Filters, stockLevelIndex: 0.66m, demandPressureIndex: 0.37m, resupplyReadinessIndex: 0.54m, shortageRiskIndex: 0.36m),
            EmergencyWater: CreateLine(CityResourceKind.EmergencyWater, stockLevelIndex: 0.74m, demandPressureIndex: 0.33m, resupplyReadinessIndex: 0.62m, shortageRiskIndex: 0.28m),
