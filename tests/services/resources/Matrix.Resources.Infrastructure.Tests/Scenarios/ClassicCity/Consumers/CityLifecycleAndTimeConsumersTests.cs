    ...
    public sealed class CityLifecycleAndTimeConsumersTests
    {
        ...
        public async Task CityCreatedConsumeAsync_WhenSeedIsApplied_SendsCommandAndLogsInformation()
        {
            ...
            Assert.Equal(
                ...
                actual: entry.LogLevel);
            Assert.Contains(
                expectedSubstring: "Initialized classic city stockpiles",
                actualString: entry.Message);
        }
        ...
        public async Task CityCreatedConsumeAsync_WhenSeedIsDuplicate_LogsDebug()
        {
            ...
            Assert.Equal(
                ...
                actual: entry.LogLevel);
            Assert.Contains(
                expectedSubstring: "Skipped duplicate classic city stockpile seed",
                actualString: entry.Message);
        }
        ...
        public async Task TickConsumeAsync_WhenAdvanceIsApplied_SendsCommandAndLogsInformation()
        {
            ...
            Assert.Equal(
                ...
                actual: entry.LogLevel);
            Assert.Contains(
                expectedSubstring: "Applied classic city stockpile time progression",
                actualString: entry.Message);
        }
        ...
        public async Task TickConsumeAsync_WhenAdvanceIsOutOfOrder_LogsDebug()
        {
            ...
            Assert.Equal(
                ...
                actual: entry.LogLevel);
            Assert.Contains(
                expectedSubstring: "Skipped out-of-order classic city stockpile time progression",
                actualString: entry.Message);
        }
        ...
        public async Task TickConsumeAsync_WhenAdvanceIsDuplicate_LogsDebug()
        {
            ...
            Assert.Equal(
                ...
                actual: entry.LogLevel);
            Assert.Contains(
                expectedSubstring: "Skipped duplicate classic city stockpile time progression",
                actualString: entry.Message);
        }
        ...
        public async Task TickConsumeAsync_WhenStateIsNotInitialized_LogsDebug()
        {
            ...
            Assert.Equal(
                ...
                actual: entry.LogLevel);
            Assert.Contains(
                expectedSubstring: "state is not initialized yet",
                actualString: entry.Message);
        }
