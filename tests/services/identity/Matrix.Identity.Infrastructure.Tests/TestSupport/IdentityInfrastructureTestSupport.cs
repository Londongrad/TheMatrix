...
namespace Matrix.Identity.Infrastructure.Tests.TestSupport
{
    internal static class IdentityInfrastructureTestSupport
    {
        ...
        internal static IdentityTestDatabase CreateDbContext()
        {
            ...
            return new IdentityTestDatabase(
                dbContext: dbContext,
    ...
    internal sealed class FakeDefaultUserAccessPolicyRepository : IDefaultUserAccessPolicyRepository
    {
        ...
        public DefaultUserAccessPolicy Policy { get; set; } =
            DefaultUserAccessPolicy.CreateDefault(IdentityInfrastructureTestSupport.CreatedAtUtc);
