...
namespace Matrix.Identity.Application.Tests.UseCases.Self
{
    internal static class SelfServiceHandlerTestSupport
    {
        ...
        internal static RefreshTokenCommand CreateRefreshCommand(
        ...
        internal static RevokeRefreshTokenCommand CreateRevokeRefreshTokenCommand(
            string refreshToken = "incoming-refresh-token",
            string? ipAddress = "127.0.0.1",
            string? userAgent = "Mozilla/5.0")
        {
        ...
        internal static RevokeMySessionCommand CreateRevokeMySessionCommand(Guid sessionId)
        {
            return new RevokeMySessionCommand(sessionId);
        }

        internal static RevokeOtherMySessionsCommand CreateRevokeOtherMySessionsCommand()
        {
            return new RevokeOtherMySessionsCommand();
        }

        internal static RevokeAllMySessionsCommand CreateRevokeAllMySessionsCommand()
        {
            return new RevokeAllMySessionsCommand();
        }

        internal static ChangePasswordCommand CreateChangePasswordCommand(
        ...
        internal static ChangeDisplayNameCommand CreateChangeDisplayNameCommand(string? displayName = "Thomas Anderson")
        {
            return new ChangeDisplayNameCommand(displayName);
        }

        internal static ChangeUsernameCommand CreateChangeUsernameCommand(
        ...
        internal static ChangeAvatarFromFileCommand CreateChangeAvatarFromFileCommand(
        ...
        internal static ClearAvatarCommand CreateClearAvatarCommand()
        {
            return new ClearAvatarCommand();
        }

        internal static DeleteMyAccountCommand CreateDeleteMyAccountCommand(
            string currentPassword = "CurrentPa$$w0rd",
            string? ipAddress = "127.0.0.1",
            string? userAgent = "Mozilla/5.0")
        {
        ...
        internal static ResetPasswordCommand CreateResetPasswordCommand(
            Guid userId,
        ...
        internal static SendPasswordResetCommand CreateSendPasswordResetCommand(
            string email = "neo@matrix.local",
            string? ipAddress = "127.0.0.1",
            string? userAgent = "Mozilla/5.0")
        {
            return new SendPasswordResetCommand(
                Email: email,
                IpAddress: ipAddress,
                UserAgent: userAgent);
        }

        internal static RequestEmailChangeCommand CreateRequestEmailChangeCommand(
        ...
        internal static ConfirmEmailChangeCommand CreateConfirmEmailChangeCommand(
            Guid userId,
        ...
        internal static CancelPendingEmailChangeCommand CreateCancelPendingEmailChangeCommand(
            string? ipAddress = "127.0.0.1",
            string? userAgent = "Mozilla/5.0")
        {
            return new CancelPendingEmailChangeCommand(
                IpAddress: ipAddress,
                UserAgent: userAgent);
        }

        internal static ResendPendingEmailChangeCommand CreateResendPendingEmailChangeCommand(
            string? ipAddress = "127.0.0.1",
            string? userAgent = "Mozilla/5.0")
        {
            return new ResendPendingEmailChangeCommand(
                IpAddress: ipAddress,
                UserAgent: userAgent);
        }

        internal static SendEmailConfirmationCommand CreateSendEmailConfirmationCommand(
            string email = "neo@matrix.local",
            string? ipAddress = "127.0.0.1",
            string? userAgent = "Mozilla/5.0")
        {
        ...
        internal static ConfirmEmailCommand CreateConfirmEmailCommand(
            Guid userId,
        ...
        internal static RequestAccountRecoveryCommand CreateRequestAccountRecoveryCommand(
            string email = "neo@matrix.local",
            string? ipAddress = "127.0.0.1",
            string? userAgent = "Mozilla/5.0")
        {
            return new RequestAccountRecoveryCommand(
                Email: email,
                IpAddress: ipAddress,
                UserAgent: userAgent);
        }

        internal static ConfirmAccountRecoveryCommand CreateConfirmAccountRecoveryCommand(
            Guid userId,
            string token = "raw-account-recovery-token",
            string? ipAddress = "127.0.0.1",
            string? userAgent = "Mozilla/5.0")
        {
            return new ConfirmAccountRecoveryCommand(
                UserId: userId,
                Token: token,
                IpAddress: ipAddress,
                UserAgent: userAgent);
        ...
        internal static RefreshTokenCommandHandler CreateRefreshHandler(
        ...
        internal static RevokeRefreshTokenCommandHandler CreateRevokeRefreshHandler(
            FakeUserRepository userRepository,
            FakeUserSessionRepository userSessionRepository,
            FakeRefreshTokenProvider refreshTokenProvider,
            FakeUnitOfWork unitOfWork,
            ...
            TimeProvider? timeProvider = null)
        {
            return new RevokeRefreshTokenCommandHandler(
                userRepository: userRepository,
                userSessionRepository: userSessionRepository,
                refreshTokenProvider: refreshTokenProvider,
                unitOfWork: unitOfWork,
        ...
        internal static ResetPasswordCommandHandler CreateResetPasswordHandler(
            FakeUserRepository userRepository,
            FakeUserSessionRepository userSessionRepository,
        ...
        internal static RevokeMySessionCommandHandler CreateRevokeMySessionHandler(
            FakeUserRepository userRepository,
            FakeUserSessionRepository userSessionRepository,
            FakeUnitOfWork unitOfWork,
            ...
            TimeProvider? timeProvider = null)
        {
            return new RevokeMySessionCommandHandler(
                userRepository: userRepository,
                userSessionRepository: userSessionRepository,
                unitOfWork: unitOfWork,
                timeProvider: timeProvider ?? CreateTimeProvider(),
        ...
        internal static RevokeOtherMySessionsCommandHandler CreateRevokeOtherMySessionsHandler(
            FakeUserRepository userRepository,
            FakeUserSessionRepository userSessionRepository,
            FakeUnitOfWork unitOfWork,
            FakeCurrentUserContext currentUser,
            ...
            TimeProvider? timeProvider = null)
        {
            return new RevokeOtherMySessionsCommandHandler(
                userRepository: userRepository,
                userSessionRepository: userSessionRepository,
                unitOfWork: unitOfWork,
                timeProvider: timeProvider ?? CreateTimeProvider(),
        ...
        internal static RevokeAllMySessionsCommandHandler CreateRevokeAllMySessionsHandler(
            FakeUserRepository userRepository,
            FakeUserSessionRepository userSessionRepository,
            FakeUnitOfWork unitOfWork,
            FakeCurrentUserContext currentUser,
            ...
            TimeProvider? timeProvider = null)
        {
            return new RevokeAllMySessionsCommandHandler(
                userRepository: userRepository,
                userSessionRepository: userSessionRepository,
                unitOfWork: unitOfWork,
                timeProvider: timeProvider ?? CreateTimeProvider(),
        ...
        internal sealed class FakeUserSessionRepository : IUserSessionRepository
        {
            ...
            public Task<IReadOnlyCollection<UserSession>> ListByUserIdAsync(
                Guid userId,
                CancellationToken cancellationToken = default)
            {
                RequestedUserId = userId;
            ...
            public Task<IReadOnlyCollection<UserSession>> ListByUserIdAndDeviceIdAsync(
                Guid userId,
                string deviceId,
                CancellationToken cancellationToken = default)
            {
            ...
            public Task<IReadOnlyCollection<UserSession>> ListActiveByUserIdAsync(
                Guid userId,
                DateTime utcNow,
                CancellationToken cancellationToken = default)
            {
            ...
            public Task<(IReadOnlyCollection<UserSession> Items, int TotalCount)> GetEndedPageByUserIdAsync(
                Guid userId,
                DateTime utcNow,
            ...
            public Task<UserSession?> GetActiveByUserIdAndDeviceIdAsync(
                Guid userId,
                string deviceId,
                DateTime utcNow,
                CancellationToken cancellationToken = default)
            ...
            public Task<DateTime?> GetLastVisitedAtUtcAsync(
                Guid userId,
                CancellationToken cancellationToken = default)
            {
                throw new NotSupportedException();
        ...
        internal sealed class FakeGeoLocationService : IGeoLocationService
        {
            ...
            public Task<GeoLocation?> ResolveAsync(
                string ipAddress,
                CancellationToken cancellationToken = default)
            {
        ...
        internal sealed class FakeEmailSender : IEmailSender
        {
            ...
            public List<(string ToEmail, string PreviousUsername, string NewUsername)> UsernameChangedEmails { get; } =
                new();
        ...
        internal sealed class FakeOneTimeTokenDeliveryService : IOneTimeTokenDeliveryService
        {
            ...
            public List<(string Email, string? IpAddress, string? UserAgent)> EmailConfirmationRequests { get; } =
                new();
        ...
        {
            public CursorPagedResult<SecurityActivityItemResult>? Result { get; set; }
            public (Guid UserId, SecurityActivityCursor? Cursor, int PageSize)? Request { get; private set; }

            public Task<CursorPagedResult<SecurityActivityItemResult>> GetSliceByUserIdAsync(
                Guid userId,
                ...
                CancellationToken cancellationToken)
            {
                ...
                return Task.FromResult(
                    Result ??
                    new CursorPagedResult<SecurityActivityItemResult>(
