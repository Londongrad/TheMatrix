    ...
    internal static class AdminRolesTestSupport
    {
        ...
        internal sealed class FakeRoleReadRepository : IRoleReadRepository
        {
                ...
                CancellationToken cancellationToken)
            {
                ...
                bool exists = RolesById.Values.Any(x => x.Id != excludedRoleId && x.Name == roleName) ||
                              ExistingNames.Contains(roleName);
        ...
        internal sealed class FakeUserRepository : IUserRepository
        {
            ...
            {
                RequestedRoleId = roleId;
                UserIdsByRoleId.TryGetValue(
                    key: roleId,
                    value: out IReadOnlyCollection<Guid>? userIds);
