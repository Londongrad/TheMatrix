...
namespace Matrix.Identity.Application.Tests.Services.Identity
{
    ...
    internal sealed class DeliveryFakeOneTimeTokenRepository : IOneTimeTokenRepository
    {
        ...
        public (Guid UserId, OneTimeTokenPurpose Purpose, DateTime SinceUtc)? CountCreatedSinceUtcRequest
        {
            get;
            private set;
        }
    ...
    internal sealed class DeliveryFakeEmailSender : IEmailSender
    {
        ...
        public List<(string ToEmail, string CurrentEmail, string ConfirmationLink)> EmailChangeConfirmationEmails
        {
            get;
        } = new();
