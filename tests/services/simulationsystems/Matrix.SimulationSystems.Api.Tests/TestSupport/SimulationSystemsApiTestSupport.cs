    ...
    public static class SimulationSystemsApiTestSupport
    {
            ...
            string? budgetAuthorizationStatus = "Approved")
        {
            return new CityDrainageStatusDto(
                ...
                System: new CityDrainageSystemStatusDto(
                    Kind: "Drainage",
                    LoadIndex: 0.36m,
                    ServiceQualityIndex: 0.84m,
                    BacklogIndex: 0.18m,
                    FailureRiskIndex: 0.12m));
        }
            ...
            string? budgetAuthorizationStatus = "Approved")
        {
            return new CityHeatingStatusDto(
                ...
                PendingOperation: CreatePendingOperationDto(
                    ...
                    intensity: "Focused",
                    readyAtTickId: 43),
                System: new CityHeatingSystemStatusDto(
                    Kind: "Heating",
                    LoadIndex: 0.33m,
                    ServiceQualityIndex: 0.87m,
                    BacklogIndex: 0.15m,
                    FailureRiskIndex: 0.10m));
        }
            ...
            string? budgetAuthorizationStatus = "Approved")
        {
            return new CityWaterDistributionStatusDto(
                ...
                PendingOperation: CreatePendingOperationDto(
                    ...
                    intensity: "Elevated",
                    readyAtTickId: 44),
                System: new CityWaterDistributionSystemStatusDto(
                    Kind: "WaterDistribution",
                    LoadIndex: 0.35m,
            ...
            string? budgetAuthorizationStatus = "Approved")
        {
            return new CitySanitationStatusDto(
                ...
                PendingOperation: CreatePendingOperationDto(
                    ...
                    intensity: "Stabilize",
                    readyAtTickId: 45),
                System: new CitySanitationSystemStatusDto(
                    Kind: "Sanitation",
                    LoadIndex: 0.38m,
                    ServiceQualityIndex: 0.82m,
                    BacklogIndex: 0.21m,
                    FailureRiskIndex: 0.14m));
        }
            ...
            string? budgetAuthorizationStatus = "Approved")
        {
            return new CityPowerDistributionStatusDto(
                ...
                PendingOperation: CreatePendingOperationDto(
                    ...
                    intensity: "Elevated",
                    readyAtTickId: 46),
                System: new CityPowerDistributionSystemStatusDto(
                    Kind: "PowerDistribution",
                    LoadIndex: 0.29m,
                    ServiceQualityIndex: 0.90m,
                    BacklogIndex: 0.13m,
            ...
            string? budgetAuthorizationStatus = "Approved")
        {
            return new CitySnowRemovalStatusDto(
                ...
                PendingOperation: CreatePendingOperationDto(
                    ...
                    intensity: "Focused",
                    readyAtTickId: 47),
                System: new CitySnowRemovalSystemStatusDto(
                    Kind: "SnowRemoval",
                    LoadIndex: 0.32m,
                    ServiceQualityIndex: 0.85m,
                    BacklogIndex: 0.17m,
                    FailureRiskIndex: 0.11m));
        }
            ...
            string? budgetAuthorizationStatus = "Approved")
        {
            return new CityRoadAccessStatusDto(
                ...
                PendingOperation: CreatePendingOperationDto(
                    ...
                    intensity: "Stabilize",
                    readyAtTickId: 48),
                System: new CityRoadAccessSystemStatusDto(
                    Kind: "RoadAccess",
                    LoadIndex: 0.34m,
                    ServiceQualityIndex: 0.83m,
                    BacklogIndex: 0.18m,
                    FailureRiskIndex: 0.13m));
        }
            ...
            Guid? focusDistrictId = null)
        {
            return new CityUtilityIncidentStatusDto(
                ...
                PendingOperation: CreatePendingOperationDto(
                    ...
                    intensity: "Rapid",
                    readyAtTickId: 49),
                System: new CityUtilityIncidentSystemStatusDto(
                    Kind: "UtilityIncidents",
                    LoadIndex: 0.37m,
                    ServiceQualityIndex: 0.82m,
                    BacklogIndex: 0.23m,
                    FailureRiskIndex: 0.16m));
        }

        public static CityDistrictUtilityIncidentConditionsDto CreateUtilityIncidentDistrictConditionsDto(
            Guid? cityId = null)
        {
        ...
        public static IConfiguration BuildValidApiConfiguration()
        {
            Dictionary<string, string?> values = new()
            {
                ["ConnectionStrings:SimulationSystemsDb"] =
                    "Host=localhost;Port=5432;Database=simulationsystems_tests;Username=postgres;Password=postgres",
        ...
        private static CityResourceSupplyConditionDto CreateResourceSupplyConditionDto()
        {
            return new CityResourceSupplyConditionDto(
                ...
                Fuel: CreateResourceSupplyLineConditionDto(
                    stockLevelIndex: 0.72m,
                    resupplyReadinessIndex: 0.76m,
                    shortageRiskIndex: 0.15m),
                SpareParts: CreateResourceSupplyLineConditionDto(
                    stockLevelIndex: 0.68m,
                    resupplyReadinessIndex: 0.73m,
                    shortageRiskIndex: 0.18m),
                Filters: CreateResourceSupplyLineConditionDto(
                    stockLevelIndex: 0.81m,
                    resupplyReadinessIndex: 0.79m,
                    shortageRiskIndex: 0.11m),
                EmergencyWater: CreateResourceSupplyLineConditionDto(
                    stockLevelIndex: 0.75m,
                    resupplyReadinessIndex: 0.70m,
                    shortageRiskIndex: 0.16m));
        }
