...
internal static class SimulationSystemsInfrastructureTestSupport
{
    ...
    internal static readonly DateTimeOffset CreatedAtUtc = new(2053, 4, 5, 8, 0, 0, TimeSpan.Zero);
    ...
    {
        var options = new DbContextOptionsBuilder<SimulationSystemsDbContext>()
