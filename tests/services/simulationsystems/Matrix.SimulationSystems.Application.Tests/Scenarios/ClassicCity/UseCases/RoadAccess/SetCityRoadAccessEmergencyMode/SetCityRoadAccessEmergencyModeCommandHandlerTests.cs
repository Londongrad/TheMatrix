...
namespace Matrix.SimulationSystems.Application.Tests.Scenarios.ClassicCity.UseCases.RoadAccess.SetCityRoadAccessEmergencyMode;
...
public sealed class SetCityRoadAccessEmergencyModeCommandHandlerTests
{
    ...
    public async Task Handle_WhenStateDoesNotExist_ReturnsNull()
    {
        ...
        var result = await handler.Handle(
            new SetCityRoadAccessEmergencyModeCommand(
