...
{
    internal static readonly DateTimeOffset DefaultCreatedAtUtc = new(2048, 2, 3, 4, 5, 6, TimeSpan.Zero);
        ...
        decimal taxAmount = 25m)
    {
        return new CityHouseholdObligation(
            ...
            createdAtUtc: DefaultCreatedAtUtc,
            firstChargeDueAtUtc: firstChargeDueAtUtc ?? new DateTimeOffset(2048, 2, 10, 0, 0, 0, TimeSpan.Zero),
            unitProfile: CreateUnitProfile(),
