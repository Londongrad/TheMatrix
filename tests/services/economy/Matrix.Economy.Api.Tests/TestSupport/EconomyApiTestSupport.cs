...
public static class EconomyApiTestSupport
{
    ...
    public static CityOperationalBudgetPressureDto CreateOperationalPressureDto(Guid cityId)
    {
        return new CityOperationalBudgetPressureDto(
            CityId: cityId,
            EffectiveTickId: 42,
            EffectiveAtUtc: new DateTimeOffset(2048, 6, 1, 9, 30, 0, TimeSpan.Zero),
            UnitKind: "Currency",
            UnitCode: "CRD",
            UnitDisplayName: "Credits",
            UnitSymbol: "C",
    ...
    public static CityBudgetAllocationDto CreateBudgetAllocationDto(Guid cityId, string category = "Operations")
    {
    ...
    public static CityHouseholdAccountLedgerEntryDto CreateHouseholdAccountLedgerEntryDto(string title = "Household purchase")
    {
    ...
    public static IConfiguration BuildValidApiConfiguration()
    {
        ...
        {
            ["ConnectionStrings:EconomyDb"] = "Host=localhost;Port=5432;Database=economy_tests;Username=postgres;Password=postgres",
