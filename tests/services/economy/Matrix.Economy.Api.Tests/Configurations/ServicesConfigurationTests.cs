...
{
    [Fact]
    public void ConfigureApplicationServices_WhenEconomyDbConnectionStringIsMissing_ThrowsInvalidOperationException()
    {
        ...
        Assert.Contains("Connection string 'EconomyDb' is not configured", exception.Message);
    }
