...
namespace Matrix.Population.Application.Tests.Scenarios.ClassicCity.UseCases.Population.AdvanceCityPopulation
{
    public sealed class ResidentProgressionStepTests
    {
        ...
        private static readonly DateTimeOffset ToUtc = new(
            year: 2048,
            month: 5,
            day: 2,
            hour: 15,
        ...
        public async Task ApplyAsync_WhenNoProgressionIsRequiredAndNoExposureExists_ReturnsFalse()
        {
            ...
            Assert.Equal(
                expected: 0,
                actual: routingService.TotalCallCount);
        }
        ...
        public async Task ApplyAsync_WhenExposureSegmentsExist_AppliesWeatherExposureWithoutDateProgression()
        {
            ...
            CityPopulationWeatherExposurePolicy policy = CreateWeatherExposurePolicy();
        ...
        private static IReadOnlyDictionary<HouseholdId, HouseholdEntity> CreateHouseholdsById(HouseholdId householdId)
        {
        ...
        private static CityWeatherExposureSegment CreateAdverseWeatherSegment(DateOnly currentDate)
        {
