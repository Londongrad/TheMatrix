...
public sealed class ResidentLivingConditionsProgressionStepTests
{
    ...
    private static readonly DateTimeOffset EffectiveAtUtc = new(2048, 5, 3, 12, 0, 0, TimeSpan.Zero);
    ...
    public void Apply_WhenLivingConditionsAreDegraded_AppliesPressureEffect()
    {
        ...
        CityPopulationLivingConditionsContext expectedLivingConditions = districtImpactPolicy.ResolveLivingConditions(
            districtId: null,
    ...
    public void Apply_WhenDistrictUtilitySnapshotExists_UsesDistrictUtilityConditions()
    {
        ...
        CityDistrictUtilityConditionsSnapshot utilitySnapshot = CreateSevereUtilityConditionsSnapshot(TestDistrictId);
        var districtImpactPolicy = new CityPopulationDistrictImpactPolicy();
        var livingConditionsPressurePolicy = new CityPopulationLivingConditionsPressurePolicy();
        CityPopulationLivingConditionsContext expectedLivingConditions = districtImpactPolicy.ResolveLivingConditions(
    ...
    private static CityDistrictUtilityConditionsSnapshot CreateSevereUtilityConditionsSnapshot(DistrictId districtId)
    {
