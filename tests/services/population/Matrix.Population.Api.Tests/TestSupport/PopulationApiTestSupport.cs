...
{
    public static PersonDto CreatePersonDto(Guid? id = null, string fullName = "Thomas Anderson")
    {
    ...
    public static CityResidentDetailsDto CreateResidentDetailsDto(Guid? id = null, string fullName = "Thomas Anderson")
    {
    ...
    public static CityEmploymentOperationResultDto CreateEmploymentOperationResultDto(string action = "Hire")
    {
        return new CityEmploymentOperationResultDto(
            Action: action,
            RecordedAtUtc: new DateTimeOffset(2048, 6, 1, 10, 30, 0, TimeSpan.Zero),
    ...
    public static CityEducationOperationResultDto CreateEducationOperationResultDto(string action = "Enroll")
    {
        return new CityEducationOperationResultDto(
            Action: action,
            RecordedAtUtc: new DateTimeOffset(2048, 6, 1, 10, 45, 0, TimeSpan.Zero),
            Resident: CreateResidentDetailsDto());
    }

    public static CityCivilRegistryOperationResultDto CreateCivilRegistryOperationResultDto(string action = "Marriage")
    {
        return new CityCivilRegistryOperationResultDto(
            Action: action,
            RecordedAtUtc: new DateTimeOffset(2048, 6, 1, 11, 0, 0, TimeSpan.Zero),
    ...
    public static IConfiguration BuildValidApiConfiguration()
    {
        ...
        {
            ["ConnectionStrings:PopulationDb"] = "Host=localhost;Port=5432;Database=population_tests;Username=postgres;Password=postgres",
