...
namespace Matrix.Population.Api.Tests.Configurations
{
    public sealed class ServicesConfigurationTests
    {
        [Fact]
        public void
            ConfigureApplicationServices_WhenPopulationDbConnectionStringIsMissing_ThrowsInvalidOperationException()
        {
            ...
            Assert.Contains(
                expectedSubstring: "Connection string 'PopulationDb' is not configured",
