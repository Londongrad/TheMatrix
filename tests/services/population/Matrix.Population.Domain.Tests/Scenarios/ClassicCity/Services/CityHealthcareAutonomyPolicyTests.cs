...
public sealed class CityHealthcareAutonomyPolicyTests
{
    ...
    public void ResolveSupportStrength_WhenCareAccessAndHouseholdSupportAreStrong_ReturnsHigherSupport()
    {
        ...
        Matrix.Population.Domain.Entities.Person illResident = PopulationTestData.CreateAdultPerson(
        ...
        Matrix.Population.Domain.Entities.Person employedCaregiver = PopulationTestData.CreateAdultPerson(
            firstName: "Olga",
            lastName: "Ivanova",
            sex: Sex.Female,
        ...
        double highSupport = policy.ResolveSupportStrength(
            ...
            householdResidents: [illResident, employedCaregiver],
            housingStatus: HousingStatus.Housed,
            currentDate: currentDate,
            hasPrimaryCareAccess: true,
            hasDistrictPrimaryCareAccess: true,
            ...
            healthcarePressureProfile: new Matrix.Population.Domain.Scenarios.ClassicCity.Models.CityPopulationHealthcarePressureProfile(
    ...
    public void ResolveSupportStrength_WhenDistrictInfrastructureIsFragile_ReducesSupport()
    {
        ...
        Matrix.Population.Domain.Entities.Person seniorResident = PopulationTestData.CreateAdultPerson(
            birthDate: new DateOnly(1960, 5, 1),
            currentDate: currentDate);
        ...
        Matrix.Population.Domain.Entities.Person caregiver = PopulationTestData.CreateAdultPerson(
            firstName: "Maria",
            lastName: "Ivanova",
            sex: Sex.Female,
        ...
        double stableSupport = policy.ResolveSupportStrength(
            ...
            householdResidents: [seniorResident, caregiver],
            housingStatus: HousingStatus.Housed,
            currentDate: currentDate,
            hasPrimaryCareAccess: true,
            hasDistrictPrimaryCareAccess: true,
            districtUtilityConditions: CreateDistrictUtilitySnapshot(dispatchReadiness: 0.9m, pressure: 0.2m, coordinationDifficulty: 0.1m, restorationPriority: 0.1m),
        ...
        double fragileSupport = policy.ResolveSupportStrength(
            ...
            hasPrimaryCareAccess: true,
            hasDistrictPrimaryCareAccess: true,
            districtUtilityConditions: CreateDistrictUtilitySnapshot(dispatchReadiness: 0.2m, pressure: 0.9m, coordinationDifficulty: 0.8m, restorationPriority: 0.7m),
            serviceQualityState: CreateServiceQualityState(1.1m));
