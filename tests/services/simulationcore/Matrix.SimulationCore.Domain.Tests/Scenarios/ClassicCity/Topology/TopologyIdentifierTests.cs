...
public sealed class TopologyIdentifierTests
{
    ...
    {
        var exception = Assert.Throws<DomainException>(() => new CityAnchorId(Guid.Empty));
    ...
    {
        var exception = Assert.Throws<DomainException>(() => new DistrictId(Guid.Empty));
    ...
    {
        var exception = Assert.Throws<DomainException>(() => new ResidentialBuildingId(Guid.Empty));
    ...
    {
        var exception = Assert.Throws<DomainException>(() => new RoadNodeId(Guid.Empty));
    ...
    {
        var exception = Assert.Throws<DomainException>(() => new RoadSegmentId(Guid.Empty));
