...
internal static class TopologyTestData
{
    ...
    internal static readonly RoadNodeId AlternativeRoadNodeId = new(Guid.Parse("20000000-0000-0000-0000-000000000004"));
    internal static readonly DateTimeOffset CreatedAtUtc = new(2044, 6, 7, 8, 9, 10, TimeSpan.Zero);
    internal static readonly DateTimeOffset NonUtcCreatedAt = new(2044, 6, 7, 8, 9, 10, TimeSpan.FromHours(3));
