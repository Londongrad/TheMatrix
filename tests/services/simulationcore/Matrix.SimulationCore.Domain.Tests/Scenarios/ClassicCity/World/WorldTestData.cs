...
internal static class WorldTestData
{
    ...
    internal static readonly RoadSegmentId FirstRoadSegmentId = new(Guid.Parse("30000000-0000-0000-0000-000000000007"));
    internal static readonly RoadSegmentId SecondRoadSegmentId = new(Guid.Parse("30000000-0000-0000-0000-000000000008"));
    ...
    internal static readonly DateTimeOffset StartedAtUtc = new(2045, 7, 8, 9, 10, 11, TimeSpan.Zero);
    internal static readonly DateTimeOffset NonUtcStartedAt = new(2045, 7, 8, 9, 10, 11, TimeSpan.FromHours(3));
