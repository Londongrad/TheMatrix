...
export function IconUsers() {
  return (
    ...
    >
      ...
      />
      <path
        d="M19 20c0-1.8-1-3.3-2.5-3.8"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
      <path
        d="M17 6.9a2.8 2.8 0 0 1 0 5.4"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
...
export function IconKey() {
  return (
    ...
    >
      <path
        d="M10 14a5 5 0 1 1 2.2-4.1L21 9v4h-3v3h-3v3h-3l-2.3-2.3"
        stroke="currentColor"
        strokeWidth="1.6"
...
export function IconOpen() {
  return (
    ...
    >
      ...
      />
      <path
        d="M2 12s3-6 8-6 8 6 8 6-3 6-8 6-8-6-8-6Z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
