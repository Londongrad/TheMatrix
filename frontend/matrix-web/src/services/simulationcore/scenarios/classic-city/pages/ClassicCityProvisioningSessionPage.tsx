...
} from "@services/simulationcore/scenarios/classic-city/components/ProvisioningTimeline";
import {getCity, getCityProvisioning,} from "@services/simulationcore/scenarios/classic-city/api/citiesApi";
import {getClassicCitySetupSession} from "@services/simulationcore/scenarios/classic-city/api/setupSessionsApi";
import type {
...
import {useCityProvisioning} from "@services/simulationcore/scenarios/classic-city/hooks/useCityProvisioning";
import {
    ...
    return [
        {
            ...
            title: "Creating city",
            description: hasCity
                ? `${cityName ?? "City host"} was created in SimulationCore with topology, clock, and initial environment.`
                : launchFailed
...
export default function ClassicCityProvisioningSessionPage() {
    ...
    const canInspectLiveCity = can(PermissionKeys.SimulationCoreClassicCityRead) && can(PermissionKeys.SimulationCoreSimulationRead);
    const canRetryBootstrap = can(PermissionKeys.SimulationCoreClassicCityPopulationBootstrapRetry) && canInspectLiveCity;
                    ...
                    <div className="scenario-setup__panel">
                        ...
                        <div className="scenario-setup__review-grid">
                            ...
                            <article className="scenario-setup__review-card">
                                ...
                                <span className="scenario-setup__review-text">
                                    {city ? formatSimulationKindLabel(city.simulationKind) : "Waiting for SimulationCore handoff"}
                                </span>
                            </article>
                            ...
                            <article className="scenario-setup__review-card">
                                ...
                                <strong
                                    ...
                                    title={failureCode ? `${formatProvisioningFailureCode(failureCode)} (${failureCode})` : undefined}
                                >
