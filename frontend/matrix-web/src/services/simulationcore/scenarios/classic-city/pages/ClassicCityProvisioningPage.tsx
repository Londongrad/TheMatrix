...
function getResultCopy(
    ...
    if (bootstrapOutcome === "skipped") {
        return "SimulationCore finished the launch without a population bootstrap stage. Monitoring can continue from the host itself.";
    }
    ...
    return [
        {
            ...
            title: "Creating city",
            description: city
                ? `${city.name} is registered in SimulationCore with topology, clock, and environment state.`
                : "Loading city host state from SimulationCore.",
...
export default function ClassicCityProvisioningPage() {
    ...
    const canRetryBootstrap = can(PermissionKeys.SimulationCoreClassicCityPopulationBootstrapRetry);
