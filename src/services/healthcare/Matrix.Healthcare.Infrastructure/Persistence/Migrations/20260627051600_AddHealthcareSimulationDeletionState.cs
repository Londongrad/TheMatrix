...
{
    /// <inheritdoc />
    public partial class AddHealthcareSimulationDeletionState : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "healthcare_simulation_deletions",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_healthcare_simulation_deletions", x => x.simulation_host_id);
                });
        }
