...
namespace Matrix.Healthcare.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260709140500_AddPatientHouseholds")]
    partial class AddPatientHouseholds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Matrix.Healthcare.Domain.Patients.PatientMedicalRecord", b =>
                {
                    ...
                    b.HasIndex("SimulationHostId", "CommunityId")
            ...
            modelBuilder.Entity("Matrix.Healthcare.Domain.Patients.PatientProfile", b =>
                {
                    ...
                    b.HasIndex("SimulationHostId", "HouseholdId")
            ...
            modelBuilder.Entity("Matrix.Healthcare.Domain.Progression.PatientHealthProgressionBatchSet", b =>
                {
                    ...
                    b.Property<int>("AcuteCareDeliveryCount")
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("EmergencyCareDeliveryCount")
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("ProcessedPatientCount")
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("RecordedCareDeliveryBatchCount")
                        .HasColumnType("integer")
                        .HasColumnName("recorded_care_delivery_batch_count");

                    b.Property<int>("RoutineCareDeliveryCount")
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("UrgentCareDeliveryCount")
                        .HasColumnType("integer")
