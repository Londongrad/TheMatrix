...
namespace Matrix.Healthcare.Application
{
    public static class DependencyInjection
    {
        public static void AddHealthcareApplication(this IServiceCollection services)
        {
            ...
            services.AddSingleton<PatientEnvironmentalHealthPolicy>();
            services.AddSingleton<PatientHealthcareSupportPolicy>();
            ...
            services.AddSingleton<CareSystemPressurePolicy>();
