...
{
    internal static class PopulationResidentVitalStateCommandMapper
    {
            ...
            PopulationResidentVitalStateBatchV1 message)
        {
            ...
            if (string.IsNullOrWhiteSpace(message.CorrelationId))
                throw new ArgumentException(
                    message: "A resident vital state correlation identifier is required.",
            ...
            if (message.TotalBatches <= 0
                ...
                throw new ArgumentException(
                    message: "Resident vital state batch position metadata is invalid.",
                    paramName: nameof(message));
