namespace Matrix.SimulationCore.Contracts.Scenarios.ClassicCity.Cities
{
    public static class PopulationBootstrapFailureCodes
    {
        ...
        public const string PopulationResidentialCapacityMissing = "POPULATION_RESIDENTIAL_CAPACITY_MISSING";
        public const string PopulationSummaryInconsistent = "POPULATION_SUMMARY_INCONSISTENT";
