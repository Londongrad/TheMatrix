...
{
    public sealed class RequestAccountRecoveryCommandHandler(IOneTimeTokenDeliveryService oneTimeTokenDeliveryService)
        : IRequestHandler<RequestAccountRecoveryCommand>
    {
