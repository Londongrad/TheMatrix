...
namespace Matrix.Population.Domain.Errors
{
    public static class DomainErrorsFactory
    {
        ...
        public static DomainException PersonNotMarried(PersonId personId, string? propertyName = null) =>
            new(
                code: "Population.Person.Marital.PersonNotMarried",
                message: $"Person {personId} is not married.",
                propertyName: propertyName);

        public static DomainException SpouseNotMarried(PersonId personId, string? propertyName = null) =>
            new(
        ...
        public static DomainException CannotMarrySelf(PersonId personId, string? propertyName = null)
            => new(
                code: "Population.Person.Marital.CannotMarrySelf",
                message: $"Person '{personId}' cannot marry themselves.",
                propertyName: propertyName);

        public static DomainException CannotDivorceSelf(PersonId personId, string? propertyName = null)
            => new(
        ...
        public static DomainException PersonAlreadyMarried(PersonId personId, string? propertyName = null)
            => new(
                code: "Population.Person.Marital.PersonAlreadyMarried",
                message: $"Person '{personId}' is already married.",
                propertyName: propertyName);

        public static DomainException SpouseAlreadyMarried(PersonId spouseId, string? propertyName = null)
            => new(
                code: "Population.Person.Marital.SpouseAlreadyMarried",
                message: $"Spouse '{spouseId}' is already married.",
                propertyName: propertyName);

        public static DomainException CannotBecomeWidowedOfSelf(PersonId widowId, string? propertyName = null) =>
            new(
                code: "Population.Person.Marital.CannotBecomeWidowedOfSelf",
                message: $"Person '{widowId}' cannot become widowed of themselves.",
                propertyName: propertyName);

        public static DomainException WidowMustBeAlive(PersonId widowId, string? propertyName = null) =>
            new(
                code: "Population.Person.Marital.WidowMustBeAlive",
                message: $"Person '{widowId}' must be alive to become widowed.",
                propertyName: propertyName);

        public static DomainException WidowMustBeMarried(PersonId widowId, string? propertyName = null) =>
            new(
                code: "Population.Person.Marital.WidowMustBeMarried",
                message: $"Person '{widowId}' must be married to become widowed.",
                propertyName: propertyName);

        public static DomainException DeceasedMustBeDeceased(PersonId deceasedId, string? propertyName = null) =>
            new(
                code: "Population.Person.Marital.DeceasedMustBeDeceased",
                message: $"Person '{deceasedId}' must be deceased to make someone widowed.",
                propertyName: propertyName);

        public static DomainException DeceasedMustBeMarried(PersonId deceasedId, string? propertyName = null) =>
            new(
