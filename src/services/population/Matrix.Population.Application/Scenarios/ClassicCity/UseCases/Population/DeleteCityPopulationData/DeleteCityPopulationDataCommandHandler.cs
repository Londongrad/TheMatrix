            ...
            return unitOfWork.ExecuteInTransactionAsync(
                action: async ct =>
                {
                    ...
                    await cityPopulationProgressionStateRepository.DeleteByCityAsync(
                        cityId: cityId,
                        cancellationToken: ct);
                    await cityPopulationServiceQualityStateRepository.DeleteByCityAsync(
                        cityId: cityId,
                        cancellationToken: ct);
                    await healthcarePressureSnapshotRepository.DeleteByCityAsync(
                        cityId: cityId,
                        cancellationToken: ct);
                    await pendingWeatherImpactRepository.DeleteByCityAsync(
                        cityId: cityId,
                        cancellationToken: ct);
                    ...
                    await cityPopulationSummaryProjectionService.DeleteAsync(
                        cityId: cityId,
                        cancellationToken: ct);
                    await cityPopulationActivityJournalService.DeleteByCityAsync(
                        cityId: cityId,
                        cancellationToken: ct);
