...
{
    public sealed class ApplyCityEnvironmentSyncCommandValidator : AbstractValidator<ApplyCityEnvironmentSyncCommand>
    {
        public ApplyCityEnvironmentSyncCommandValidator()
        {
            RuleFor(x => x.CityId)
               .NotEmpty();
