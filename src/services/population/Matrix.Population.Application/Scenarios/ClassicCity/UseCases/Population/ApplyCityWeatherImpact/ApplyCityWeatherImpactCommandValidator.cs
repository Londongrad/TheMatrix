...
{
    public sealed class ApplyCityWeatherImpactCommandValidator : AbstractValidator<ApplyCityWeatherImpactCommand>
    {
        public ApplyCityWeatherImpactCommandValidator()
        {
            RuleFor(x => x.CityId)
               .NotEmpty();
