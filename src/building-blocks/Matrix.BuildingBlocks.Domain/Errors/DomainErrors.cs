...
namespace Matrix.BuildingBlocks.Domain.Errors
{
    public static class DomainErrors
    {
        ...
        public static DomainException InvalidEnum<TEnum>(TEnum value, string propertyName)
        ...
        public static DomainException InvalidStringToEnum<TEnum>(string value, string propertyName)
            where TEnum : struct, Enum =>
            new(
        ...
        public static DomainException OutOfRange<T>(T min, T max, string propertyName)
        ...
        public static DomainException InvalidDateRange(DateOnly from, DateOnly to, string fromName, string toName) =>
            new(
