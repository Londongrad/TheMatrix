...
namespace Matrix.BuildingBlocks.Application.Models
{
        ...
        int pageSize)
    {
        ...
        /// </summary>
        public int PageNumber { get; init; } = GuardHelper.AgainstNonPositiveNumber(pageNumber, nameof(PageNumber));

        /// <summary>
        /// The number of items per page.
        /// </summary>
        public int PageSize { get; init; } = GuardHelper.AgainstNonPositiveNumber(pageSize, nameof(PageSize));
