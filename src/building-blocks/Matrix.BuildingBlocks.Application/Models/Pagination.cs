namespace Matrix.BuildingBlocks.Application.Models
{
    ...
    public sealed record Pagination
    {
        ...
        /// <param name="pageSize">The number of items to include in a single page. Must be between 1 and <see cref="MaxPageSize"/>.</param>
        ...
        /// </summary>
        public static Pagination Default => new(1, 100);
